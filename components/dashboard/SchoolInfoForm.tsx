...
export default function SchoolInfoForm({ initialData }: { initialData: any }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      facebook: initialData?.facebook || "https://www.facebook.com/61588790410182/posts/122099072523293013/?app=fbl",
      twitter: initialData?.twitter || "",
      instagram: initialData?.instagram || "",
      youtube: initialData?.youtube || "",
      telegram: initialData?.telegram || "https://t.me/+Dz7TPl163oFhODY0",
